...
import { WritingTourTrigger } from "@/components/StudentTour";
    ...
    <div className="min-h-screen">
      ...
      <main className="max-w-3xl mx-auto px-4 py-8 space-y-4">
        ...
        {timerEndAt && timerRemaining !== null && (
          <div id="tour-timer" className={`rounded-xl border-2 p-4 text-center ${
        ...
        {/* Task text */}
        {taskText && (
          <div id="tour-task-text" className="bg-blue-50 border border-blue-200 rounded-xl p-5">
        ...
        {/* Editor card */}
        <div id="tour-editor-card" className="bg-white rounded-xl border border-gray-200 p-6">
          <h1 className="text-xl font-bold text-gray-900 mb-4">
            {existingText ? "Rediger tekst" : "Skriv tekst"}
          </h1>

          <form onSubmit={handleSubmit}>
            <div id="tour-writing-tools" className="mb-4">
              <RichTextEditor
                content={content}
                onChange={setContent}
            ...
            <div className="flex items-center justify-between">
              ...
              <div id="tour-autosave" className="text-sm">
