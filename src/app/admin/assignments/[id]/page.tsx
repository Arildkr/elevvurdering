        ...
        <div className="space-y-5">
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-5">
            ...
            <div className="flex gap-3 flex-wrap">
              ...
              <a href={`/api/assignments/${id}/export?format=csv`} className="bg-gray-100 text-gray-700 px-4 py-2 rounded-lg text-sm font-medium hover:bg-gray-200 transition-colors">
                Eksporter CSV
              </a>
              <button
                onClick={() => {
                  ...
                  alert(`1. Åpne Google Sheets:\n${googleSheetsUrl}\n\n2. Gå til Fil > Åpne > Last opp\n3. Velg CSV-filen\n\nAlternativt, importer via URL:\n${csvUrl}`);
