...
export const KNOWN_CONFUSIONS_NN: Record<string, Confusion> = {
  ...
  jore:        { standard: "gjorde",               rule: "gj/j" },
  jort:        { standard: "gjort",                rule: "gj/j" },
  jøre:        { standard: "gjere/gjøre",          rule: "gj/j" },
  ...
  sjylling:    { standard: "kylling",              rule: "skj/sj" },
  sjøre:       { standard: "kjøre",                rule: "skj/sj" },
  sjønner:     { standard: "skjønar/skjønner",     rule: "skj/sj" },
  kjønner:     { standard: "skjønar/skjønner",     rule: "skj/sj" },
  ...
  dette:       { standard: "dette/det",            rule: "bokmål" },
  aldri:       { standard: "aldri",               rule: "bokmål" },
  alltid:      { standard: "alltid",              rule: "bokmål" },
  ...
  arbeidstakerar: { standard: "arbeidstakarar",         rule: "bokmål" },
  ...
  greit:          { standard: "greitt",                 rule: "bokmål" },
  ...
  meinar:         { standard: "meiner",                 rule: "bokmål" },
  ...
  nyskjerrig:     { standard: "nysgjerrig",             rule: "bokmål" },
  oppmerksomhet:  { standard: "merksemd",               rule: "bokmål" },
  opprinneleg:    { standard: "opphavleg",              rule: "bokmål" },
